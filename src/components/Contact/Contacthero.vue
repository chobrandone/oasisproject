                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-9">
                            <div class="hero__caption text-center">
                                <h1 class="text-center" >OASIS    <span>PLANET TECH</span> WORLD</h1>
                                 <h5 class="text-center" >YOUR WELCOME   <span>TO </span> OUR  <span>WORLD OF </span>KNOWLEDGE</h5>
                            </div>
                            <!--Hero form -->
...
<script>
// import hero from "../../assets/img/hero/video.png"
export default {
    data() {
        return {
...
.slider-active{
    ...
    background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url("../../assets/img/contact/contact.jpg");
     min-height: 400px;
...
@media (max-width: 575px) {
    ...
    .slider-active{
    /* background-image: url(../../assets/img/hero/video.jpg); */
    background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.8)), url("../../assets/img/contact/contact.jpg");
     min-height: 100px;
    background-repeat: no-repeat;
    background-position: center center;
    background-size: cover
...
.slider-area .hero__caption  h5 span {
    color: #EDC750;
}
