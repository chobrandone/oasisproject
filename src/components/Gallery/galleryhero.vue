                        ...
                        <div class="col-xl-9 col-lg-9">
                            <div class="hero__caption text-center">
                                <h1 class="text-center" >OASIS    <span>PLANET TECH</span> WORLD</h1>
                                 <h5 class="text-center" >YOUR WELCOME   <span>TO </span> OUR  <span>GALLERY </span></h5>
                            </div>
                            <!--Hero form -->
...
@media (max-width: 575px) {
    ...
    .slider-active{
    /* background-image: url(../../assets/img/hero/video.jpg); */
    background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.8)), url("../../assets/img/hero/service3.jpeg");
     min-height: 100px;
    background-repeat: no-repeat;
    background-position: center center;
    background-size: cover
